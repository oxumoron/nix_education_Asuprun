...
const getProductAll = () => {
    ...
    `;
      ...
      `
        ...
        btnInPopup.addEventListener('click', addToCartPopup); btnInPopup.addEventListener('click', checkCounter());
    ...
    `;
        ...
        const regBtn = document.querySelector('.btn__reg.btn__sign'); regBtn.addEventListener('click', async () => {
          const user = {
